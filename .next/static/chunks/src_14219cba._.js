...
;
;
function SimplePagination(param) {
    let { data = [], itemsPerPage = 6, children, className = "", emptyMessage = "No data found" } = param;
    _s();
...
_s(SimplePagination, "6xAUoJ2motYJ38x4zeUWisA+X/4=");
_c = SimplePagination;
var _c;
...
//# sourceMappingURL=src_14219cba._.js.map