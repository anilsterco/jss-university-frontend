...
export default function Programs() {
  ...
  const [selectedSchools, setSelectedSchools] = useState(['School Of Engineering']);
                ...
                <div className={styles.programCategory}>
                  ...
                  <div className={styles.programCategoryBox}>
                    ...
                    {schools.map((school, index) => (
                      <div key={school} className={`form-check ${styles.formCheck}`}>
                        <input
                          className="check-box"
                          type="checkbox"
                  ...
                  <div className={styles.programCategoryBox}>
                    ...
                    {departments.map((department, index) => (
                      <div key={department} className={`form-check ${styles.formCheck}`}>
                        <input
                          className="check-box"
                          type="checkbox"
                  ...
                  <div className={styles.programListBoxs}>
                    {programs.map((program, index) => (
                      <div key={index} className={styles.cusProgramBox}>
                        ...
                        <a href={program.link} className={styles.strechedLink}></a>
                      </div>
                    ))}
                  </div>
